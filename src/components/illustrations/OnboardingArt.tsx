...
export function UnreadablePhotoArt({ size = 140 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 140 140">
      <Rect
        x={18}
        ...
        height={78}
        rx={14}
        fill={theme.illustration.stone}
      />
      <Circle cx={70} cy={73} r={24} fill={theme.illustration.stoneDark} />
      <Circle cx={70} cy={73} r={11} fill="#CDC4B2" />
      <Path
        d="M28 118 L112 30"
        stroke={theme.primary.clay}
        strokeWidth={5}
...
export function OfflineArt({ size = 140 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 140 140">
      <Path
        d="M32 84 C32 62 48 48 70 48 C92 48 108 62 108 84"
        stroke={theme.illustration.stoneDark}
        strokeWidth={9}
        fill="none"
        strokeLinecap="round"
      />
      <Path
        d="M48 96 C48 84 58 76 70 76 C82 76 92 84 92 96"
        stroke={theme.illustration.stoneDark}
        strokeWidth={9}
        fill="none"
        strokeLinecap="round"
      />
      <Circle cx={70} cy={110} r={7} fill={theme.illustration.stoneDark} />
      <Path
        d="M30 118 L110 34"
        stroke={theme.primary.clay}
        strokeWidth={5}
